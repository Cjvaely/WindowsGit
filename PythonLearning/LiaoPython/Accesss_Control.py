#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Date    : 2018-05-31 14:59:30
# @Author  : Chen Cjv (cjvaely@foxmail.com)
# @Link    : https://github.com/Cjvaely
# @Version : $Id$

# 访问控制：（Accesss Control）
#
...
# 99
#
# 要让内部属性不被外部访问，可以把属性的名称前加上两个下划线__，在Python中，实例的变量名如果以__开头，就变成了一个私有变量（private），只有内部可以访问，外部不能访问，所以，我们把Student类改一改：
...
#  			self.__score = score
#
# 这种方法的优势就是：可以在方法中对参数做检查，避免无效参数的传入
